...
public class WPriorityGUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WPriorityGUI frame = new WPriorityGUI();
	...
	public WPriorityGUI() {
		...
		JLabel lblReaderPriority = new JLabel("Writer Priority");
		...
		lblNewLabel.setIcon(new ImageIcon(WPriorityGUI.class
		...
		btnStart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				WriterPriority RWEx = new WriterPriority(WPriorityGUI.this);
				for(int i=0;i<15;i++)
